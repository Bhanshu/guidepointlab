...
<form class="cart" method="post" enctype='multipart/form-data'>
				...
				foreach ( $grouped_products as $product_id ) :
					...
					<tr>
						<td>
							...
							<?php else : ?> <div class="button-action"><div class="quantity">
								<?php
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="single_add_to_cart_button button alt add-cart-btn"><?php echo $product->single_add_to_cart_text(); ?></button>
